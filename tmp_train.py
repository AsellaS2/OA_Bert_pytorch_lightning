...
inputpath = 'D:/project/OA_paper/DATA/Part/k_fold/3/'
savepath = 'D:/project/OA_paper/output/3/'

df = pd.read_csv(inputpath + 'Train3.csv', encoding='cp949')
...
# trainer = pl.Trainer(max_epochs=N_EPOCHS, gpus=1, callbacks=[checkpoint_callback], progress_bar_refresh_rate=30,
#                      resume_from_checkpoint='./lightning_logs/version_23/checkpoints/OA-epoch=00-val_loss=0.74.ckpt')
...
# 결과 저장
report.to_csv(savepath + 'report_train3.csv', index=True, encoding='cp949')
output.to_csv(savepath + 'output_train3.csv', index=False, encoding='cp949')
